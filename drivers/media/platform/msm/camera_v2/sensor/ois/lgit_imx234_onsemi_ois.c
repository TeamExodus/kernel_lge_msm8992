...
/*FILTER CALCULATOR VERSION 4.02*/
/*the time and date : 2015/2/4 09:08:36*/
/*FC filename : LC898122_FIL_G4_MTM_V0013_4th*/
/*fs,23438Hz*/
/*LSI No.,LC898122*/
/*Comment,*/

/* 32bit */
const unsigned char CsFilHRamDat_C012[] = {
	0x10, 0xB0,	/* 0x10B0 */
	0x3E, 0x00, 0x00,	 /*3E0000,10B0,Through,0dB,fs/1,invert=0*/
	0x00, 0x00, 0x00,	 /*000000,10B1,Through,0dB,fs/1,invert=0*/
	0x10, 0xB2,	/* 0x10B2 */
	...
	0x3E, 0x00, 0x00,	 /*3E0000,10D5,0dB,invert=0*/
	0x10, 0xD7,	/* 0x10D7 */
	0x46, 0xCC, 0x64,	 /*46CC64,10D7,Through,27dB,fs/1,invert=0*/
	0x00, 0x00, 0x00,	 /*000000,10D8,Through,27dB,fs/1,invert=0*/
	0x10, 0xD9,	/* 0x10D9 */
	0x00, 0x00, 0x00,	 /*000000,10D9,Through,27dB,fs/1,invert=0*/
	0x3D, 0x9E, 0x58,	 /*3D9E58,10DA,PKF,800Hz,-20dB,5,fs/1,invert=0*/
	0x10, 0xDB,	/* 0x10DB */
	0xBF, 0x7E, 0xAD,	 /*BF7EAD,10DB,PKF,800Hz,-20dB,5,fs/1,invert=0*/
	0x3F, 0x7E, 0xAD,	 /*3F7EAD,10DC,PKF,800Hz,-20dB,5,fs/1,invert=0*/
	0x10, 0xDD,	/* 0x10DD */
	0x3D, 0x88, 0xA4,	 /*3D88A4,10DD,PKF,800Hz,-20dB,5,fs/1,invert=0*/
	0xBD, 0x26, 0xFC,	 /*BD26FC,10DE,PKF,800Hz,-20dB,5,fs/1,invert=0*/
	0x10, 0xE0,	/* 0x10E0 */
	0x38, 0xAD, 0xAC,	 /*38ADAC,10E0,LPF,1500Hz,0dB,fs/1,invert=0*/
	0x38, 0xAD, 0xAC,	 /*38ADAC,10E1,LPF,1500Hz,0dB,fs/1,invert=0*/
	0x10, 0xE2,	/* 0x10E2 */
	0x3C, 0xA9, 0x2A,	 /*3CA92A,10E2,LPF,1500Hz,0dB,fs/1,invert=0*/
	0x00, 0x00, 0x00,	 /*000000,10E3,LPF,1500Hz,0dB,fs/1,invert=0*/
	0x10, 0xE4,	/* 0x10E4 */
	0x00, 0x00, 0x00,	 /*000000,10E4,LPF,1500Hz,0dB,fs/1,invert=0*/
	0x3E, 0x00, 0x00,	 /*3E0000,10E5,0dB,invert=0*/
	0x10, 0xE8,	/* 0x10E8 */
	0x3E, 0x00, 0x00,	 /*3E0000,10E8,0dB,invert=0*/
	0x00, 0x00, 0x00,	 /*000000,10E9,Cutoff,invert=0*/
	...
	0x3E, 0x00, 0x00,	 /*3E0000,1203,0dB,invert=0*/
	0x12, 0x04,	/* 0x1204 */
	0x45, 0x21, 0xFB,	 /*4521FB,1204,HBF,45Hz,1000Hz,23dB,fs/1,invert=0*/
	0xC5, 0x18, 0x5D,	 /*C5185D,1205,HBF,45Hz,1000Hz,23dB,fs/1,invert=0*/
	0x12, 0x06,	/* 0x1206 */
	0x3D, 0x0D, 0xEF,	 /*3D0DEF,1206,HBF,45Hz,1000Hz,23dB,fs/1,invert=0*/
	0x38, 0x37, 0x8A,	 /*38378A,1207,LPF,1200Hz,0dB,fs/1,invert=0*/
	0x12, 0x08,	/* 0x1208 */
	0x38, 0x37, 0x8A,	 /*38378A,1208,LPF,1200Hz,0dB,fs/1,invert=0*/
	0x3C, 0xE4, 0x3B,	 /*3CE43B,1209,LPF,1200Hz,0dB,fs/1,invert=0*/
...
/*FILTER CALCULATOR VERSION 4.02*/
/*the time and date : 2015/2/4 09:08:05*/
...
/* 32bit */
const unsigned char CsFilHRamDat_C011[] = {
	0x10, 0xB0,	/* 0x10B0 */
	0x3E, 0x00, 0x00,	 /*3E0000,10B0,Through,0dB,fs/1,invert=0*/
	0x00, 0x00, 0x00,	 /*000000,10B1,Through,0dB,fs/1,invert=0*/
	0x10, 0xB2,	/* 0x10B2 */
	...
	0x10, 0xD9,	/* 0x10D9 */
	0x00, 0x00, 0x00,	 /*000000,10D9,Through,27dB,fs/1,invert=0*/
	0x3D, 0xA9, 0xB6,	 /*3DA9B6,10DA,PKF,950Hz,-16dB,5,fs/1,invert=0*/
	0x10, 0xDB,	/* 0x10DB */
	0xBF, 0x7C, 0x0E,	 /*BF7C0E,10DB,PKF,950Hz,-16dB,5,fs/1,invert=0*/
	0x3F, 0x7C, 0x0E,	 /*3F7C0E,10DC,PKF,950Hz,-16dB,5,fs/1,invert=0*/
	0x10, 0xDD,	/* 0x10DD */
	0x3D, 0x89, 0x35,	 /*3D8935,10DD,PKF,950Hz,-16dB,5,fs/1,invert=0*/
	0xBD, 0x32, 0xEB,	 /*BD32EB,10DE,PKF,950Hz,-16dB,5,fs/1,invert=0*/
	0x10, 0xE0,	/* 0x10E0 */
	0x37, 0xC8, 0x42,	 /*37C842,10E0,LPF,1000Hz,0dB,fs/1,invert=0*/
	0x37, 0xC8, 0x42,	 /*37C842,10E1,LPF,1000Hz,0dB,fs/1,invert=0*/
	0x10, 0xE2,	/* 0x10E2 */
	0x3D, 0x0D, 0xEF,	 /*3D0DEF,10E2,LPF,1000Hz,0dB,fs/1,invert=0*/
	0x00, 0x00, 0x00,	 /*000000,10E3,LPF,1000Hz,0dB,fs/1,invert=0*/
	0x10, 0xE4,	/* 0x10E4 */
	0x00, 0x00, 0x00,	 /*000000,10E4,LPF,1000Hz,0dB,fs/1,invert=0*/
	0x3E, 0x00, 0x00,	 /*3E0000,10E5,0dB,invert=0*/
	0x10, 0xE8,	/* 0x10E8 */
	0x3E, 0x00, 0x00,	 /*3E0000,10E8,0dB,invert=0*/
	0x00, 0x00, 0x00,	 /*000000,10E9,Cutoff,invert=0*/
...
/*FILTER CALCULATOR VERSION 4.02*/
/*the time and date : 2015/2/4 09:07:48*/
...
/* 32bit */
const unsigned char CsFilHRamDat_C010[] = {
	0x10, 0xB0,	/* 0x10B0 */
	0x3E, 0x00, 0x00,	 /*3E0000,10B0,Through,0dB,fs/1,invert=0*/
	0x00, 0x00, 0x00,	 /*000000,10B1,Through,0dB,fs/1,invert=0*/
	0x10, 0xB2,	/* 0x10B2 */
	...
	0x3D, 0xFF, 0xC1,	 /*3DFFC1,10CB,LPF,0.9Hz,38dB,fs/1,invert=0*/
	0x10, 0xCC,	/* 0x10CC */
	0x38, 0x2F, 0x36,	 /*382F36,10CC,LBF,5Hz,26Hz,-3dB,fs/1,invert=0*/
	0xB8, 0x2B, 0x54,	 /*B82B54,10CD,LBF,5Hz,26Hz,-3dB,fs/1,invert=0*/
	0x10, 0xCE,	/* 0x10CE */
	0x3D, 0xFE, 0xA1,	 /*3DFEA1,10CE,LBF,5Hz,26Hz,-3dB,fs/1,invert=0*/
	0x10, 0xD0,	/* 0x10D0 */
	0x3F, 0xFD, 0x93,	 /*3FFD93,10D0,6dB,invert=0*/
	0x00, 0x00, 0x00,	 /*000000,10D1,Cutoff,invert=0*/
	0x10, 0xD2,	/* 0x10D2 */
	...
	0x10, 0xD9,	/* 0x10D9 */
	0x00, 0x00, 0x00,	 /*000000,10D9,Through,27dB,fs/1,invert=0*/
	0x3D, 0x93, 0x42,	 /*3D9342,10DA,PKF,1500Hz,-14dB,5,fs/1,invert=0*/
	0x10, 0xDB,	/* 0x10DB */
	0xBF, 0x33, 0x23,	 /*BF3323,10DB,PKF,1500Hz,-14dB,5,fs/1,invert=0*/
	0x3F, 0x33, 0x23,	 /*3F3323,10DC,PKF,1500Hz,-14dB,5,fs/1,invert=0*/
	0x10, 0xDD,	/* 0x10DD */
	0x3D, 0x5D, 0x0C,	 /*3D5D0C,10DD,PKF,1500Hz,-14dB,5,fs/1,invert=0*/
	0xBC, 0xF0, 0x4E,	 /*BCF04E,10DE,PKF,1500Hz,-14dB,5,fs/1,invert=0*/
	0x10, 0xE0,	/* 0x10E0 */
	0x37, 0xC8, 0x42,	 /*37C842,10E0,LPF,1000Hz,0dB,fs/1,invert=0*/
	0x37, 0xC8, 0x42,	 /*37C842,10E1,LPF,1000Hz,0dB,fs/1,invert=0*/
	0x10, 0xE2,	/* 0x10E2 */
	...
	0x3E, 0x00, 0x00,	 /*3E0000,1203,0dB,invert=0*/
	0x12, 0x04,	/* 0x1204 */
	0x45, 0x22, 0x84,	 /*452284,1204,HBF,50Hz,1000Hz,23dB,fs/1,invert=0*/
	0xC5, 0x17, 0xD4,	 /*C517D4,1205,HBF,50Hz,1000Hz,23dB,fs/1,invert=0*/
	0x12, 0x06,	/* 0x1206 */
	0x3D, 0x0D, 0xEF,	 /*3D0DEF,1206,HBF,50Hz,1000Hz,23dB,fs/1,invert=0*/
	0x38, 0x37, 0x8A,	 /*38378A,1207,LPF,1200Hz,0dB,fs/1,invert=0*/
	0x12, 0x08,	/* 0x1208 */
	0x38, 0x37, 0x8A,	 /*38378A,1208,LPF,1200Hz,0dB,fs/1,invert=0*/
	0x3C, 0xE4, 0x3B,	 /*3CE43B,1209,LPF,1200Hz,0dB,fs/1,invert=0*/
	...
	0x12, 0x0C,	/* 0x120C */
	0x3D, 0x97, 0xC9,	 /*3D97C9,120C,LPF,400Hz,0dB,fs/1,invert=0*/
	0x2F, 0xE5, 0x2A,	 /*2FE52A,120D,LPF,1.6Hz,31dB,fs/1,invert=0*/
	0x12, 0x0E,	/* 0x120E */
	0x2F, 0xE5, 0x2A,	 /*2FE52A,120E,LPF,1.6Hz,31dB,fs/1,invert=0*/
	0x3D, 0xFF, 0x90,	 /*3DFF90,120F,LPF,1.6Hz,31dB,fs/1,invert=0*/
	0x12, 0x10,	/* 0x1210 */
	0x3A, 0xD3, 0xD1,	 /*3AD3D1,1210,LBF,6Hz,34Hz,6dB,fs/1,invert=0*/
	0xBA, 0xCD, 0x40,	 /*BACD40,1211,LBF,6Hz,34Hz,6dB,fs/1,invert=0*/
	0x12, 0x12,	/* 0x1212 */
	0x3D, 0xFE, 0x5B,	 /*3DFE5B,1212,LBF,6Hz,34Hz,6dB,fs/1,invert=0*/
	0x3F, 0xFD, 0x93,	 /*3FFD93,1213,6dB,invert=0*/
	0x12, 0x14,	/* 0x1214 */
	0x00, 0x00, 0x00,	 /*000000,1214,Cutoff,invert=0*/
	0x41, 0xFB, 0x28,	 /*41FB28,1215,12dB,invert=0*/
...
/*FILTER CALCULATOR VERSION 4.02*/
/*the time and date : 2015/2/3 15:54:29*/
...
/* 32bit */
const unsigned char CsFilHRamDat_C002[] = {
	0x10, 0xB0,	/* 0x10B0 */
	0x3E, 0x00, 0x00,	 /*3E0000,10B0,Through,0dB,fs/1,invert=0*/
	0x00, 0x00, 0x00,	 /*000000,10B1,Through,0dB,fs/1,invert=0*/
	0x10, 0xB2,	/* 0x10B2 */
...
/*FILTER CALCULATOR VERSION 4.02*/
/*the time and date : 2015/2/3 15:53:03*/
...
/* 32bit */
const unsigned char CsFilHRamDat_C001[] = {
	0x10, 0xB0,	/* 0x10B0 */
	0x3E, 0x00, 0x00,	 /*3E0000,10B0,Through,0dB,fs/1,invert=0*/
	0x00, 0x00, 0x00,	 /*000000,10B1,Through,0dB,fs/1,invert=0*/
	0x10, 0xB2,	/* 0x10B2 */
	...
	0x3D, 0xFF, 0xC1,	 /*3DFFC1,10CB,LPF,0.9Hz,38dB,fs/1,invert=0*/
	0x10, 0xCC,	/* 0x10CC */
	0x38, 0x74, 0x84,	 /*387484,10CC,LBF,10Hz,26Hz,-8dB,fs/1,invert=0*/
	0xB8, 0x70, 0x26,	 /*B87026,10CD,LBF,10Hz,26Hz,-8dB,fs/1,invert=0*/
	0x10, 0xCE,	/* 0x10CE */
	0x3D, 0xFD, 0x42,	 /*3DFD42,10CE,LBF,10Hz,26Hz,-8dB,fs/1,invert=0*/
	0x10, 0xD0,	/* 0x10D0 */
	0x3F, 0xFD, 0x93,	 /*3FFD93,10D0,6dB,invert=0*/
	0x00, 0x00, 0x00,	 /*000000,10D1,Cutoff,invert=0*/
	0x10, 0xD2,	/* 0x10D2 */
	...
	0x10, 0xD9,	/* 0x10D9 */
	0x00, 0x00, 0x00,	 /*000000,10D9,Through,30dB,fs/1,invert=0*/
	0x3D, 0xE4, 0xD6,	 /*3DE4D6,10DA,PKF,850Hz,-6dB,5,fs/1,invert=0*/
	0x10, 0xDB,	/* 0x10DB */
	0xBF, 0xB0, 0xB1,	 /*BFB0B1,10DB,PKF,850Hz,-6dB,5,fs/1,invert=0*/
	0x3F, 0xB0, 0xB1,	 /*3FB0B1,10DC,PKF,850Hz,-6dB,5,fs/1,invert=0*/
	0x10, 0xDD,	/* 0x10DD */
	0x3D, 0xAE, 0x3F,	 /*3DAE3F,10DD,PKF,850Hz,-6dB,5,fs/1,invert=0*/
	0xBD, 0x93, 0x15,	 /*BD9315,10DE,PKF,850Hz,-6dB,5,fs/1,invert=0*/
	0x10, 0xE0,	/* 0x10E0 */
	0x38, 0x37, 0x8A,	 /*38378A,10E0,LPF,1200Hz,0dB,fs/1,invert=0*/
	0x38, 0x37, 0x8A,	 /*38378A,10E1,LPF,1200Hz,0dB,fs/1,invert=0*/
	0x10, 0xE2,	/* 0x10E2 */
	0x3C, 0xE4, 0x3B,	 /*3CE43B,10E2,LPF,1200Hz,0dB,fs/1,invert=0*/
	0x00, 0x00, 0x00,	 /*000000,10E3,LPF,1200Hz,0dB,fs/1,invert=0*/
	0x10, 0xE4,	/* 0x10E4 */
	0x00, 0x00, 0x00,	 /*000000,10E4,LPF,1200Hz,0dB,fs/1,invert=0*/
	0x3E, 0x00, 0x00,	 /*3E0000,10E5,0dB,invert=0*/
	0x10, 0xE8,	/* 0x10E8 */
	0x3E, 0x00, 0x00,	 /*3E0000,10E8,0dB,invert=0*/
	0x00, 0x00, 0x00,	 /*000000,10E9,Cutoff,invert=0*/
...
/*FILTER CALCULATOR VERSION 4.02*/
/*the time and date : 2015/2/3 15:52:10*/
...
/* 32bit */
const unsigned char CsFilHRamDat_C000[] = {
	0x10, 0xB0,	/* 0x10B0 */
	0x3E, 0x00, 0x00,	 /*3E0000,10B0,Through,0dB,fs/1,invert=0*/
	0x00, 0x00, 0x00,	 /*000000,10B1,Through,0dB,fs/1,invert=0*/
	0x10, 0xB2,	/* 0x10B2 */
	...
	0x00, 0x00, 0x00,	 /*000000,10B9,Cutoff,invert=0*/
	0x10, 0xC0,	/* 0x10C0 */
	0x3F, 0x3B, 0xD0,	 /*3F3BD0,10C0,HBF,50Hz,800Hz,5dB,fs/1,invert=0*/
	0xBF, 0x30, 0xCB,	 /*BF30CB,10C1,HBF,50Hz,800Hz,5dB,fs/1,invert=0*/
	0x10, 0xC2,	/* 0x10C2 */
	0x3D, 0x39, 0xA9,	 /*3D39A9,10C2,HBF,50Hz,800Hz,5dB,fs/1,invert=0*/
	0x3E, 0x00, 0x00,	 /*3E0000,10C3,Through,0dB,fs/1,invert=0*/
	0x10, 0xC4,	/* 0x10C4 */
	0x00, 0x00, 0x00,	 /*000000,10C4,Through,0dB,fs/1,invert=0*/
	0x00, 0x00, 0x00,	 /*000000,10C5,Through,0dB,fs/1,invert=0*/
	...
	0x10, 0xC8,	/* 0x10C8 */
	0x3D, 0x97, 0xC9,	 /*3D97C9,10C8,LPF,400Hz,0dB,fs/1,invert=0*/
	0x30, 0x68, 0x40,	 /*306840,10C9,LPF,1.4Hz,34dB,fs/1,invert=0*/
	0x10, 0xCA,	/* 0x10CA */
	0x30, 0x68, 0x40,	 /*306840,10CA,LPF,1.4Hz,34dB,fs/1,invert=0*/
	0x3D, 0xFF, 0x9E,	 /*3DFF9E,10CB,LPF,1.4Hz,34dB,fs/1,invert=0*/
	0x10, 0xCC,	/* 0x10CC */
	0x3C, 0xB0, 0x2F,	 /*3CB02F,10CC,LBF,8Hz,15Hz,2dB,fs/1,invert=0*/
	0xBC, 0xAD, 0x6C,	 /*BCAD6C,10CD,LBF,8Hz,15Hz,2dB,fs/1,invert=0*/
	0x10, 0xCE,	/* 0x10CE */
	0x3D, 0xFD, 0xCE,	 /*3DFDCE,10CE,LBF,8Hz,15Hz,2dB,fs/1,invert=0*/
	0x10, 0xD0,	/* 0x10D0 */
	0x3F, 0xFD, 0x93,	 /*3FFD93,10D0,6dB,invert=0*/
	0x38, 0xD8, 0x62,	 /*38D862,10D1,-15dB,invert=0*/
	0x10, 0xD2,	/* 0x10D2 */
	0x3E, 0x00, 0x00,	 /*3E0000,10D2,0dB,invert=0*/
	0x3C, 0x01, 0x37,	 /*3C0137,10D3,-6dB,invert=0*/
	0x10, 0xD4,	/* 0x10D4 */
	...
	0x12, 0x0C,	/* 0x120C */
	0x3D, 0x97, 0xC9,	 /*3D97C9,120C,LPF,400Hz,0dB,fs/1,invert=0*/
	0x2F, 0x78, 0xB9,	 /*2F78B9,120D,LPF,1.6Hz,30dB,fs/1,invert=0*/
	0x12, 0x0E,	/* 0x120E */
	0x2F, 0x78, 0xB9,	 /*2F78B9,120E,LPF,1.6Hz,30dB,fs/1,invert=0*/
	0x3D, 0xFF, 0x90,	 /*3DFF90,120F,LPF,1.6Hz,30dB,fs/1,invert=0*/
	0x12, 0x10,	/* 0x1210 */
	0x3A, 0xD5, 0x8B,	 /*3AD58B,1210,LBF,8Hz,32Hz,3dB,fs/1,invert=0*/
	0xBA, 0xCF, 0x59,	 /*BACF59,1211,LBF,8Hz,32Hz,3dB,fs/1,invert=0*/
	0x12, 0x12,	/* 0x1212 */
	0x3D, 0xFD, 0xCE,	 /*3DFDCE,1212,LBF,8Hz,32Hz,3dB,fs/1,invert=0*/
	0x3F, 0xFD, 0x93,	 /*3FFD93,1213,6dB,invert=0*/
	0x12, 0x14,	/* 0x1214 */
	0x00, 0x00, 0x00,	 /*000000,1214,Cutoff,invert=0*/
	0x40, 0xD1, 0x82,	 /*40D182,1215,9dB,invert=0*/
...
/*Filter Calculator Version 4.02*/
/*the time and date : 2014/12/18 19:51:37*/
/*FC filename : LC898122_FIL_G4_MTM_V0013_4th*/
/*fs,23438Hz*/
/*LSI No.,LC898122*/
/*Comment,*/
...
/* 8bit */
const struct STFILREG CsFilReg_C012[FILREGTAB] = {
	{0x0111, 0x00},		/*00,0111*/
	{0x0113, 0x00},		/*00,0113*/
	{0x0114, 0x00},		/*00,0114*/
	{0x0172, 0x00},		/*00,0172*/
...
/* 32bit */
const struct STFILRAM CsFilRam_C012[FILRAMTAB] = {
	{0x1000, 0x3F800000},		/*3F800000,1000,0dB,invert=0*/
	{0x1001, 0x3F800000},		/*3F800000,1001,0dB,invert=0*/
	{0x1002, 0x00000000},		/*00000000,1002,Cutoff,invert=0*/
	{0x1003, 0x3F800000},		/*3F800000,1003,0dB,invert=0*/
	...
	{0x10DA, 0x3F679600},		/*3F679600,10DA,PKF,800Hz,-20dB,5,fs/1,invert=0*/
	{0x10DB, 0xBFDFAB40},		/*BFDFAB40,10DB,PKF,800Hz,-20dB,5,fs/1,invert=0*/
	{0x10DC, 0x3FDFAB40},		/*3FDFAB40,10DC,PKF,800Hz,-20dB,5,fs/1,invert=0*/
	{0x10DD, 0x3F622900},		/*3F622900,10DD,PKF,800Hz,-20dB,5,fs/1,invert=0*/
	{0x10DE, 0xBF49BF00},		/*BF49BF00,10DE,PKF,800Hz,-20dB,5,fs/1,invert=0*/
	{0x10E0, 0x3E2B6B00},		/*3E2B6B00,10E0,LPF,1500Hz,0dB,fs/1,invert=0*/
	{0x10E1, 0x3E2B6B00},		/*3E2B6B00,10E1,LPF,1500Hz,0dB,fs/1,invert=0*/
	{0x10E2, 0x3F2A4A80},		/*3F2A4A80,10E2,LPF,1500Hz,0dB,fs/1,invert=0*/
...
int32_t	lc898122a_version_check(void)
{
	...
	if (UcVerLow == 0x00) {							// 0x00 1st LGIT Act.
		UcVerLow = 0x00;
	} else if (UcVerLow == 0x01) {					// 0x01 3rd LGIT Act.
		UcVerLow = 0x01;
		...
		UcVerLow = 0x11;
	} else if (UcVerLow == 0x12) {					// 0x12 4th MTM Act.
		UcVerLow = 0x12;
...
//TRACE("UcVerLow =  %02x\n", UcVerLow );
	...
	if (UcVerLow == 0x00) { // UcVerLow == 0x00 // LGIT
		...
		pFilReg = (struct STFILREG *)CsFilReg_C012;
		pFilRam = (struct STFILRAM *)CsFilRam_C012;
	} else if (UcVerLow == 0x13) {	// MTM 5th Act
...
void lc898122a_init_adjust_value(void)
{
	...
	} else if (UcVerLow == 0x03) {						// LGIT 4th
	...
	} else if (UcVerLow == 0x12){
		RegWriteA(CMSDAC0, BIAS_CUR_OIS_C012);		// 0x0251	Hall DAC Current
		RegWriteA(OPGSEL0, AMP_GAIN_X_C012);			// 0x0253	Hall amp Gain X
		RegWriteA(OPGSEL1, AMP_GAIN_Y_C012);			// 0x0254	Hall amp Gain Y
	...
	if (UcVerLow == 0x00) {								// LGIT 2nd Act. 141007
		...
		RegWriteA(CMSDAC1, BIAS_CUR_AF_C012);		// 0x0252	Hall Dac current
		RegWriteA(OPGSEL2, AMP_GAIN_AF_C012);		// 0x0255	Hall amp Gain AF
	} else if (UcVerLow == 0x13) {
